...
use providers::{claude, codex, gemini, grokbuild, hermes, kimicode, openclaw, opencode, pi};
...
pub fn scan_sessions() -> Vec<SessionMeta> {
    let (r1, r2, r3, r4, r5, r6, r7, r8, r9) = std::thread::scope(|s| {
        ...
        let h8 = s.spawn(kimicode::scan_sessions);
...
pub fn load_messages(provider_id: &str, source_path: &str) -> Result<Vec<SessionMessage>, String> {
    ...
    match provider_id {
        ...
        "kimicode" => kimicode::load_messages(path),
    ...
    for root in roots {
        ...
        if validated_source.starts_with(&validated_root) {
            return match provider_id {
                ...
                "kimicode" => {
                    kimicode::delete_session(&validated_root, &validated_source, session_id)
                }
...
fn provider_roots(provider_id: &str) -> Result<Vec<PathBuf>, String> {
    let roots = match provider_id {
        ...
        "kimicode" => vec![kimicode::session_root()],
        "pi" => pi::session_roots(),
